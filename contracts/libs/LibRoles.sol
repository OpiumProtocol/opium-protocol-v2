...
library LibRoles {
    bytes32 internal constant PROTOCOL_REGISTER_ROLE = keccak256("RL1");
    bytes32 internal constant EXECUTION_FEE_RECIPIENT_REGISTER_ROLE = keccak256("RL2");
    bytes32 internal constant REDEMPTION_FEE_RECIPIENT_REGISTER_ROLE = keccak256("RL3");
