...
contract CoreErrors {
    ...
    string constant internal ERROR_CORE_ADDRESSES_AND_AMOUNTS_LENGTH_DO_NOT_MATCH = "CORE:ADDRESSES_AND_AMOUNTS_DO_NOT_MATCH";
    string constant internal ERROR_CORE_ADDRESSES_AND_DERIVATIVES_LENGTH_DOES_NOT_MATCH = "CORE:ADDRESSES_AND_DERIVATIVES_LENGTH_DOES_NOT_MATCH";
