...
export const semanticErrors = {
  ...
  ERROR_ACL_ONLY_CORE: "ERROR_ACL_ONLY_CORE",
  ERROR_ACL_ONLY_WHITELISTED: "ERROR_ACL_ONLY_WHITELISTED",
  ERROR_ACL_PROTOCOL_PAUSED: "ERROR_ACL_PROTOCOL_PAUSED",
  ERROR_ACL_ONLY_PROXY_FACTORY: "ERROR_ACL_ONLY_PROXY_FACTORY",
  ERROR_REGISTRY_ONLY_GOVERNOR: "ERROR_REGISTRY_ONLY_GOVERNOR",
  ERROR_REGISTRY_ONLY_LONG_EXECUTOR: "ERROR_REGISTRY_ONLY_LONG_EXECUTOR",
  ERROR_REGISTRY_ONLY_SHORT_EXECUTOR: "ERROR_REGISTRY_ONLY_SHORT_EXECUTOR",
...
export const protocolErrors = {
  ...
  [semanticErrors.ERROR_ACL_ONLY_CORE]: "U1",
  [semanticErrors.ERROR_ACL_ONLY_WHITELISTED]: "U2",
  [semanticErrors.ERROR_ACL_ONLY_PROXY_FACTORY]: "U3",
  [semanticErrors.ERROR_ACL_PROTOCOL_PAUSED]: "U4",
  [semanticErrors.ERROR_REGISTRY_ONLY_GOVERNOR]: "R1",
  [semanticErrors.ERROR_REGISTRY_ONLY_LONG_EXECUTOR]: "R2",
  [semanticErrors.ERROR_REGISTRY_ONLY_SHORT_EXECUTOR]: "R3",
  [semanticErrors.ERROR_REGISTRY_ONLY_GUARDIAN]: "R4",
  [semanticErrors.ERROR_REGISTRY_NOT_PAUSED]: "R5",
